...
import cn.wulin.ioc.logging.jcl.JclLoggerAdapter;
import cn.wulin.ioc.logging.jdk.JdkLoggerAdapter;
...
public class LoggerFactory {
	...
	public static void setLoggerAdapter(String loggerAdapter) {
		if (loggerAdapter != null && loggerAdapter.length() > 0) {
			setLoggerAdapter(InterfaceExtensionLoader.getExtensionLoader(LoggerAdapter.class).getExtension(loggerAdapter));
		}
	}
