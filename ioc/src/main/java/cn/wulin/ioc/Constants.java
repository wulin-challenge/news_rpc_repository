...
public class Constants {
    ...
    public static final String BRACE_PROPERTIES_KEY = "brace.properties.file";

    public static final String DEFAULT_BRACE_PROPERTIES = "brace.properties";
    ...
    public static final String DEFAULT_PROMPT = "brace>";
