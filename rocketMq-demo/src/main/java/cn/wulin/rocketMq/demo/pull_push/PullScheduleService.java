...
public class PullScheduleService {
    ...
    public static void main(String[] args) throws MQClientException {
        final MQPullConsumerScheduleService scheduleService = new MQPullConsumerScheduleService("news_default_rocketmq_group");
        scheduleService.getDefaultMQPullConsumer().setNamesrvAddr("192.168.0.107:9876;192.168.0.108:9876");
        scheduleService.setMessageModel(MessageModel.CLUSTERING);
        
        scheduleService.registerPullTaskCallback("test_5109_1__1", new PullTaskCallback() {
            @Override
