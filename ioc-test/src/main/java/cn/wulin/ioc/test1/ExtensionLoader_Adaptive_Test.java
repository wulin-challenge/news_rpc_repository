...
import cn.wulin.ioc.test1.extensionloader.adaptive.HasAdaptiveExt;
import cn.wulin.ioc.test1.extensionloader.adaptive.impl.HasAdaptiveExt_ManualAdaptive;
import cn.wulin.ioc.test1.extensionloader.ext1.SimpleExt;
import cn.wulin.ioc.test1.extensionloader.ext3.UseProtocolKeyExt;
import cn.wulin.ioc.test1.extensionloader.ext5.NoAdaptiveMethodExt;
...
public class ExtensionLoader_Adaptive_Test {
    ...
    public void test_useAdaptiveClass() throws Exception {
        InterfaceExtensionLoader<HasAdaptiveExt> loader = InterfaceExtensionLoader.getExtensionLoader(HasAdaptiveExt.class);
    ...
    public void test_getAdaptiveExtension_defaultAdaptiveKey() throws Exception {
        {
            SimpleExt ext = InterfaceExtensionLoader.getExtensionLoader(SimpleExt.class).getAdaptiveExtension();
    ...
    public void test_getAdaptiveExtension_protocolKey() throws Exception {
        UseProtocolKeyExt ext = InterfaceExtensionLoader.getExtensionLoader(UseProtocolKeyExt.class).getAdaptiveExtension();
    ...
    public void test_getAdaptiveExtension_ExceptionWhenNoAdaptiveMethodOnInterface() throws Exception {
        try {
            InterfaceExtensionLoader.getExtensionLoader(NoAdaptiveMethodExt.class).getAdaptiveExtension();
            fail();
